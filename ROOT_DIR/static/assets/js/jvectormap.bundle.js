! function(l) {
    ...
    l.fn.vectorMap = function(l) {
        ...
        if ("addMap" === l) jvm.Map.maps[arguments[1]] = arguments[2];
            ...
            if (("set" === l || "get" === l) && e[l][arguments[1]]) return t[l + (arguments[1].charAt(0).toUpperCase() + arguments[1].substr(1))].apply(t, Array.prototype.slice.call(arguments, 2));
...
function(l) {
    ...
    function t(l) {
        var t = l || window.event,
            ...
            s = 0,
            n = 0;
        if ((l = o.event.fix(t)).type = "mousewheel", "detail" in t && (s = -1 * t.detail), "wheelDelta" in t && (s = t.wheelDelta), "wheelDeltaY" in t && (s = t.wheelDeltaY), "wheelDeltaX" in t && (i = -1 * t.wheelDeltaX), "axis" in t && t.axis === t.HORIZONTAL_AXIS && (i = -1 * s, s = 0), a = 0 === s ? i : s, "deltaY" in t && (a = s = -1 * t.deltaY), "deltaX" in t && (i = t.deltaX, 0 === s && (a = -1 * i)), 0 !== s || 0 !== i) {
            if (1 === t.deltaMode) {
            ...
            return n = Math.max(Math.abs(s), Math.abs(i)), (!d || n < d) && (p(t, d = n) && (d /= 40)), p(t, n) && (a /= 40, i /= 40, s /= 40), a = Math[1 <= a ? "floor" : "ceil"](a / d), i = Math[1 <= i ? "floor" : "ceil"](i / d), s = Math[1 <= s ? "floor" : "ceil"](s / d), l.deltaX = i, l.deltaY = s, l.deltaFactor = d, l.deltaMode = 0, e.unshift(l, a, i, s), c && clearTimeout(c), c = setTimeout(m, 200), (o.event.dispatch || o.event.handle).apply(this, e)
        }
    }
    ...
    function p(l, t) {
        return i.settings.adjustOldDeltas && "mousewheel" === l.type && t % 120 == 0
    }
...
var jvm = {
    inherits: function(l, t) {
        function e() {}
        e.prototype = t.prototype, l.prototype = new e, (l.prototype.constructor = l).parentClass = t
    },
    mixin: function(l, t) {
        var e;
...
jvm.$ = jQuery, Array.prototype.indexOf || (Array.prototype.indexOf = function(l, t) {
    ...
    var s, n, r = 0,
        h = 0;
    return (l = l.replace(/(-?\d+)e(-?\d+)/g, "0")).replace(/([MmLlHhVvCcSs])\s*((?:-?\d*(?:\.\d+)?\s*,?\s*)+)/g, function(l, t, e) {
        (e = e.replace(/(\d)-/g, "$1,-").replace(/^\s+/g, "").replace(/\s+$/g, "").replace(/\s+/g, ",").split(","))[0] || e.shift();
        for (var a = 0, i = e.length; a < i; a++) e[a] = Math.round(100 * e[a]);
        switch (t) {
            case "m":
            ...
            case "V":
                return h = e[0], "l" + r + "," + h;
            case "c":
                return s = r + e[e.length - 4], n = h + e[e.length - 3], r += e[e.length - 2], h += e[e.length - 1], "v" + e.join(",");
            case "C":
                return s = e[e.length - 4], n = e[e.length - 3], r = e[e.length - 2], h = e[e.length - 1], "c" + e.join(",");
            case "s":
                return e.unshift(h - n), e.unshift(r - s), s = r + e[e.length - 4], n = h + e[e.length - 3], r += e[e.length - 2], h += e[e.length - 1], "v" + e.join(",");
            case "S":
                return e.unshift(h + h - n), e.unshift(r + r - s), s = e[e.length - 4], n = e[e.length - 3], r = e[e.length - 2], h = e[e.length - 1], "c" + e.join(",")
        }
        return ""
    }).replace(/z/g, "e")
    ...
    return this.mode = window.SVGAngle ? "svg" : "vml", this.impl = "svg" == this.mode ? new jvm.SVGCanvasElement(l, t, e) : new jvm.VMLCanvasElement(l, t, e), this.impl.mode = this.mode, this.impl
    ...
    setValues: function(l) {
        ...
        if (this.scale instanceof jvm.OrdinalScale || this.scale instanceof jvm.SimpleScale)
            for (e in l) s[e] = l[e] ? this.scale.getValue(l[e]) : this.elements[e].element.style.initial[this.params.attribute];
        else {
            if (void 0 === this.params.min || void 0 === this.params.max)
                for (e in l) a < (t = parseFloat(l[e])) && (a = t), t < i && (i = t);
            for (e in void 0 === this.params.min ? (this.scale.setMin(i), this.params.min = i) : this.scale.setMin(this.params.min), void 0 === this.params.max ? (this.scale.setMax(a), this.params.max = a) : this.scale.setMax(this.params.max), l) "indexOf" != e && (t = parseFloat(l[e]), s[e] = isNaN(t) ? this.elements[e].element.style.initial[this.params.attribute] : this.scale.getValue(t))
        }
    ...
    var t;
    jvm.Marker.parentClass.prototype.setStyle.apply(this, arguments), "r" === l && this.updateLabelPosition(), (t = !!this.shape.get("image")) != this.isImage && (this.isImage = t, this.config.style = jvm.$.extend(!0, {}, this.shape.style), this.createShape())
}, jvm.Map = function(l) {
    var t, e = this;
    ...
    for (t in this.mapData = jvm.Map.maps[this.params.map], this.markers = {}, this.regions = {}, this.regionsColors = {}, this.regionsData = {}, this.container = jvm.$("<div>").addClass("jvectormap-container"), this.params.container && this.params.container.append(this.container), this.container.data("mapObject", this), this.defaultWidth = this.mapData.width, this.defaultHeight = this.mapData.height, this.setBackgroundColor(this.params.backgroundColor), this.onResize = function() {
            e.updateSize()
        }, jvm.$(window).resize(this.onResize), jvm.Map.apiEvents) this.params[t] && this.container.bind(jvm.Map.apiEvents[t] + ".jvectormap", this.params[t]);
    ...
    applyTransform: function() {
        var l, t, e, a;
        e = this.defaultWidth * this.scale <= this.width ? (l = (this.width - this.defaultWidth * this.scale) / (2 * this.scale), (this.width - this.defaultWidth * this.scale) / (2 * this.scale)) : (l = 0, (this.width - this.defaultWidth * this.scale) / this.scale), a = this.defaultHeight * this.scale <= this.height ? (t = (this.height - this.defaultHeight * this.scale) / (2 * this.scale), (this.height - this.defaultHeight * this.scale) / (2 * this.scale)) : (t = 0, (this.height - this.defaultHeight * this.scale) / this.scale), this.transY > t ? this.transY = t : this.transY < a && (this.transY = a), this.transX > l ? this.transX = l : this.transX < e && (this.transX = e), this.canvas.applyTransformParams(this.scale, this.transX, this.transY), this.markers && this.repositionMarkers(), this.repositionLabels(), this.container.trigger("viewportChange", [this.scale / this.baseScale, this.transX, this.transY])
    },
    bindContainerEvents: function() {
        var t, e, a = !1,
            s = this;
        this.params.panOnDrag && (this.container.mousemove(function(l) {
            return a && (s.transX -= (t - l.pageX) / s.scale, s.transY -= (e - l.pageY) / s.scale, s.applyTransform(), t = l.pageX, e = l.pageY), !1
    ...
    bindContainerTouchEvents: function() {
        var n, r, h, o, m, p, c, d = this,
            l = function(l) {
                var t, e, a, i, s = l.originalEvent.touches;
                "touchstart" == l.type && (c = 0), 1 == s.length ? (1 == c && (a = d.transX, i = d.transY, d.transX -= (h - s[0].pageX) / d.scale, d.transY -= (o - s[0].pageY) / d.scale, d.applyTransform(), d.tip.hide(), (a != d.transX || i != d.transY) && l.preventDefault()), h = s[0].pageX, o = s[0].pageY) : 2 == s.length && (2 == c ? (e = Math.sqrt(Math.pow(s[0].pageX - s[1].pageX, 2) + Math.pow(s[0].pageY - s[1].pageY, 2)) / r, d.setScale(n * e, m, p), d.tip.hide(), l.preventDefault()) : (t = jvm.$(d.container).offset(), m = s[0].pageX > s[1].pageX ? s[1].pageX + (s[0].pageX - s[1].pageX) / 2 : s[0].pageX + (s[1].pageX - s[0].pageX) / 2, p = s[0].pageY > s[1].pageY ? s[1].pageY + (s[0].pageY - s[1].pageY) / 2 : s[0].pageY + (s[1].pageY - s[0].pageY) / 2, m -= t.left, p -= t.top, n = d.scale, r = Math.sqrt(Math.pow(s[0].pageX - s[1].pageX, 2) + Math.pow(s[0].pageY - s[1].pageY, 2)))), c = s.length
            };
    ...
    bindContainerPointerEvents: function() {
        var a = this,
            t = new MSGesture,
            l = this.container[0];
        (t.target = l).addEventListener("MSGestureChange", function(l) {
            var t, e;
            (0 != l.translationX || 0 != l.translationY) && (t = a.transX, e = a.transY, a.transX += l.translationX / a.scale, a.transY += l.translationY / a.scale, a.applyTransform(), a.tip.hide(), (t != a.transX || e != a.transY) && l.preventDefault()), 1 != l.scale && (a.setScale(a.scale * l.scale, l.offsetX, l.offsetY), a.tip.hide(), l.preventDefault())
    ...
    bindElementEvents: function() {
        ...
        this.container.mousemove(function(l) {
            ...
            var t = -1 === (jvm.$(this).attr("class").baseVal || jvm.$(this).attr("class")).indexOf("jvectormap-region") ? "marker" : "region",
                ...
                i = "region" == t ? r.mapData.paths[e].name : r.markers[e].config.name || "",
                s = jvm.$.Event(t + "TipShow.jvectormap"),
                n = jvm.$.Event(t + "Over.jvectormap");
            "mouseover" == l.type ? (r.container.trigger(n, [e]), n.isDefaultPrevented() || a.setHovered(!0), r.tip.text(i), r.container.trigger(s, [r.tip, e]), s.isDefaultPrevented() || (r.tip.show(), r.tipWidth = r.tip.width(), r.tipHeight = r.tip.height())) : (a.setHovered(!1), r.tip.hide(), r.container.trigger(t + "Out.jvectormap", [e]))
            ...
            i || (r.container.trigger(e, [t]), ("region" === l && r.params.regionsSelectable || "marker" === l && r.params.markersSelectable) && (e.isDefaultPrevented() || (r.params[l + "sSelectableOne"] && r.clearSelected(l + "s"), a.setSelected(!a.isSelected))))
        })
    },
    ...
    createTip: function() {
        ...
        this.tip = jvm.$("<div/>").addClass("jvectormap-tip").appendTo(jvm.$("body")), this.container.mousemove(function(l) {
            ...
            t < 5 && (t = l.pageX + 15), e < 5 && (e = l.pageY + 15), a.tip.css({
                left: t,
                top: e
            })
        })
    ...
    setScale: function(l, t, e, a, i) {
        var s, n, r, h, o, m, p, c, d, u = jvm.$.Event("zoom.jvectormap"),
            ...
            f = new jvm.$.Deferred;
        return l > this.params.zoomMax * this.baseScale ? l = this.params.zoomMax * this.baseScale : l < this.params.zoomMin * this.baseScale && (l = this.params.zoomMin * this.baseScale), void 0 !== t && void 0 !== e && (zoomStep = l / this.scale, d = a ? (c = t + this.defaultWidth * (this.width / (this.defaultWidth * l)) / 2, e + this.defaultHeight * (this.height / (this.defaultHeight * l)) / 2) : (c = this.transX - (zoomStep - 1) / l * t, this.transY - (zoomStep - 1) / l * e)), i && 0 < g ? (n = this.scale, r = (l - n) / g, h = this.transX * this.scale, m = this.transY * this.scale, o = (c * l - h) / g, p = (d * l - m) / g, s = setInterval(function() {
    ...
    createRegions: function() {
        var l, t, e = this;
        for (l in this.regionLabelsGroup = this.regionLabelsGroup || this.canvas.addGroup(), this.mapData.paths) t = new jvm.Region({
            map: this,
