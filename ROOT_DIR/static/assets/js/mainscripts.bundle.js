  ...
  activate: function() {
    ...
    $(window).on("click", function(e) {
      ...
      "i" === e.target.nodeName.toLowerCase() &&
        (a = $(
          e.target
        ).parent()), !a.hasClass("bars") && t.isOpen() && 0 === a.parents("#leftsidebar").length && (a.hasClass("js-right-sidebar") || r.fadeOut(), i.removeClass("overlay-open"));
  ...
  activate: function() {
    ...
    $(window).on("click", function(e) {
      ...
      "i" === e.target.nodeName.toLowerCase() &&
        (a = $(
          e.target
        ).parent()), !a.hasClass("js-right-sidebar") && t.isOpen() && 0 === a.parents("#rightsidebar").length && (a.hasClass("bars") || r.fadeOut(), i.removeClass("open"));
    }), $(".js-right-sidebar").on("click", function() {
      i.toggleClass("open"), t.isOpen() ? r.fadeIn() : r.fadeOut();
    });
  },
  isOpen: function() {
...
function skinChanger() {
  $(".right-sidebar .choose-skin li").on("click", function() {
    ...
    $(".right-sidebar .choose-skin li").removeClass(
      "active"
    ), e.removeClass("theme-" + t), a.addClass("active"), e.addClass("theme-" + a.data("theme"));
  });
}
      ...
      : e === ie11
        ...
        : e === ie10
          ...
          : e === opera
            ...
            : e === chrome
              ? "chrome"
              : e === firefox ? "firefox" : e === safari ? "safari" : "";
  }
}), $(function() {
